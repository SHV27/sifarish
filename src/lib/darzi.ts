 ...
 */
export const TYPESET_VERSION = 5 // 1 = Helvetica plain (S7 "Taaj") · 2 = Times canon register · 3 = v2 full-size page (36pt, links, plan-executed) · 4 = R4 tech canon · 5 = R5 lens + breathing page (stored packets re-tailor once)
