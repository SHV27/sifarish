# HISTORY.md — SIFARISH archival record (v1 → Session 8, 07-Jul → 19-Jul-2026)
# Archived verbatim from the pre-rebrief CLAUDE.md on 30-Aug-2026. Append-only; do not edit.
# New decisions go to DECISIONS.md. The lean constitution is CLAUDE.md.
